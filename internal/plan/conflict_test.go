...
applyOp: s.#Contract & {type:"Contract", slug:"apply-op", title:"Apply", confidence:"CONFIRMED", service:svc, invariants:[{id:"post", text:"done"}]}
`)
...
validate: s.#Contract & {type:"Contract", slug:"validate", title:"Validate", confidence:"CONFIRMED", service:svc, invariants:[{id:"post", text:"placed"}]}
`)
	run("add", "-A")
	run("commit", "-m", "base")
...
svc: s.#Container & {type:"Container", slug:"consumer", title:"Consumer", confidence:"CONFIRMED", kind:"service"}
validate: s.#Contract & {type:"Contract", slug:"validate", title:"Validate", confidence:"CONFIRMED", service:svc, invariants:[{id:"post", text:"placed", depends_on:[{to: w.applyOp, role:"call"}]}]}
`), 0o644))
...
svc: s.#Container & {type:"Container", slug:"consumer", title:"Consumer", confidence:"CONFIRMED", kind:"service"}
validate: s.#Contract & {type:"Contract", slug:"validate", title:"Validate", confidence:"CONFIRMED", service:svc, invariants:[{id:"post", text:"placed"}]}
cashout: s.#Contract & {type:"Contract", slug:"cashout", title:"Cashout", confidence:"CONFIRMED", service:svc, invariants:[{id:"post", text:"paid"}]}
`), 0o644))
