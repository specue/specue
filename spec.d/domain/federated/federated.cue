...
// every team's UseCases live in their own repository, and a reader sees the same
...
owner: s.#Need & {
	...
	description: "to author my UseCases and Ports in my own repository, so that other teams can depend on what I publish without my changes blocking theirs"
	frs: {
		"fr-01": {id: "fr-01", text: "A UseCase or Port lives in a repository its owner controls."},
...
reader: s.#Need & {
	...
	description: "to see the same UseCases, their statuses and their code-binding outcomes a holder of the code would see, so that I can review and reason about the system across access boundaries"
	frs: {
		"fr-01": {id: "fr-01", text: "A UseCase's status is determined the same way whether or not the code is reachable."},
